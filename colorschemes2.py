...
"""
        if(current_cycle==0):
            for led in range(0,current_cycle+1):
                strip.set_pixel_rgb(led,0x0000FF)
        if(current_cycle==1):
            for led in range(0,current_cycle+1):
                strip.set_pixel_rgb(led,0x0000FF)
        if(current_cycle==2):
            for led in range(0,current_cycle+1):
                strip.set_pixel_rgp(led,0x0000FF)
"""
